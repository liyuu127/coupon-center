...
@javax.annotation.Generated(
    ...
    comments = "Source: envoy/service/ratelimit/v2/rls.proto")
public final class RateLimitServiceGrpc {

  private RateLimitServiceGrpc() {}

  public static final String SERVICE_NAME = "envoy.service.ratelimit.v2.RateLimitService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest,
      io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse> getShouldRateLimitMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ShouldRateLimit",
      requestType = io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest.class,
      responseType = io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest,
      io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse> getShouldRateLimitMethod() {
    io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest, io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse> getShouldRateLimitMethod;
      ...
      synchronized (RateLimitServiceGrpc.class) {
        if ((getShouldRateLimitMethod = RateLimitServiceGrpc.getShouldRateLimitMethod) == null) {
          RateLimitServiceGrpc.getShouldRateLimitMethod = getShouldRateLimitMethod =
              io.grpc.MethodDescriptor.<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest, io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ShouldRateLimit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse.getDefaultInstance()))
  ...
  public static abstract class RateLimitServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void shouldRateLimit(io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest request,
        io.grpc.stub.StreamObserver<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getShouldRateLimitMethod(), responseObserver);
    }
  ...
  public static final class RateLimitServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RateLimitServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse shouldRateLimit(io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest request) {
  ...
  public static final class RateLimitServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RateLimitServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse> shouldRateLimit(
        io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SHOULD_RATE_LIMIT:
          serviceImpl.shouldRateLimit((io.envoyproxy.envoy.service.ratelimit.v2.RateLimitRequest) request,
              (io.grpc.stub.StreamObserver<io.envoyproxy.envoy.service.ratelimit.v2.RateLimitResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RateLimitServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.envoyproxy.envoy.service.ratelimit.v2.RlsProto.getDescriptor();
    }
