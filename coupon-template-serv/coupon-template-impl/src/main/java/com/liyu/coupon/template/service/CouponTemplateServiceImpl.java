package com.liyu.coupon.template.service;
...
import com.liyu.coupon.template.api.beans.rules.Discount;
import com.liyu.coupon.template.api.enums.CouponType;
import com.liyu.coupon.template.converter.CouponTemplateConverter;
import com.liyu.coupon.template.dao.CouponTemplateDao;
import com.liyu.coupon.template.dao.entity.CouponTemplate;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        com.liyu.coupon.template.dao.entity.CouponTemplate example = com.liyu.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<com.liyu.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<com.liyu.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
